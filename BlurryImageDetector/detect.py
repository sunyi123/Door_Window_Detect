...
if __name__ == '__main__':
    trained_model = torch.load('./trained_model/trained_model-Kaggle_dataset')
    ...
    # img_path = '/home/ecs-user/jzx-ai-reproduce-models/work/door_window_detect/images/vague/0fb5ada6978d04c4de62928abb476af7.jpg'
    folder = '/home/ecs-user/jzx-ai-reproduce-models/work/door_window_detect/images/qualified/'
    for file in os.listdir(folder):
        if file.endswith('.jpg'):
            img_path = os.path.join(folder, file)
            img = cv2.imread(img_path, 0)
            prediction = is_image_blurry(trained_model, img, threshold=0.5)
            print(img_path.split("/")[-1], prediction)
